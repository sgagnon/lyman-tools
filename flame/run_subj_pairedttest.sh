...
basedir=/share/awagner/sgagnon/AP/analysis/ap_memory_raw-byshockCond/group_stress/safe_threat_sourcehit-cr
...
fslinfo $basedir/cope_merged.nii.gz # dim4 40
...
####################################################################################################
# Make a paired t-test design for n subjs (40 timepoints)_
